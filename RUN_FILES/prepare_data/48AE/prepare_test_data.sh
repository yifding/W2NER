...
CODE=/afs/crc.nd.edu/user/y/yding4/AVE_project/W2NER/RUN_FILES/prepare_data/48AE/prepare_test_data_48AE.py

INPUT_DIR=/afs/crc.nd.edu/user/y/yding4/AVE_project/AE/50att/split_by_att/test
OUTPUT_DIR=/afs/crc.nd.edu/user/y/yding4/AVE_project/W2NER/RUN_FILES/prepare_data/48AE/test
MAX_SPAN_LENGTH=5
MAX_SEQ_LENGTH=100
